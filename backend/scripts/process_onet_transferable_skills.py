...
INPUT_FILE = RAW_DIR / "transferable_skills.csv"

RELATIONSHIP_FILE = (
    OUTPUT_DIR / "transferable_skill_relationships.csv"
)

CANDIDATE_FILE = (
    OUTPUT_DIR / "transferable_skill_candidates.csv"
)
...
def normalize_name(value):
    """
    Convert a skill name into a consistent comparison form.
...
def main():
    ...
    # -----------------------------------------------------
    # STEP 1: READ RAW O*NET TRANSFERABLE SKILLS
    # -----------------------------------------------------
    ...
    with open(
        ...
        for row in reader:
            ...
            # ---------------------------------------------
            # Build transferable skill candidates.
            # ---------------------------------------------
    ...
    # -----------------------------------------------------
    # STEP 3: WRITE TRANSFERABLE SKILL CANDIDATES
    # -----------------------------------------------------
    ...
    print(
        "O*NET transferable skills processing completed."
    )
    ...
    print(
        f"Unique occupation-skill relationships: "
        f"{len(relationships)}"
    )

    print(
        f"Unique transferable skill candidates: "
        f"{len(candidates)}"
    )
